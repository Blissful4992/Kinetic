...
Library.NewWindow = function(window_info)
    ...
    do -- NOTIFICATIONS
        ...
        Notifications_Folder.Parent = UI

        Container.Name = "Container"
        Container.Parent = Notifications_Folder
        Container.BackgroundColor3 = RGB(255, 255, 255)
        Container.BackgroundTransparency = 1.000
        Container.BorderSizePixel = 0
        Container.Position = U2(1, -210, 0, -10)
        Container.Size = U2(0, 200, 1, 0)
        ...
        function root.NewNotification(notification_info)
            ...
            Notification.BackgroundColor3 = WinTheme.Background
            Notification.BorderColor3 = WinTheme.Dark_Borders
            Notification.ClipsDescendants = true
            Notification.Size = U2(1, 0, 0, 0)
            ...
            Notif_Title.Position = U2(0, 5, 0, 0)
            Notif_Title.Size = U2(1, -5, 0, 20)
            Notif_Title.ZIndex = 10002
            Notif_Title.Font = Enum.Font.GothamSemibold
            Notif_Title.Text = notification_info.Title
            Notif_Title.TextColor3 = WinTheme.Text_Color
            Notif_Title.TextSize = 12.000
            Notif_Title.TextXAlignment = Enum.TextXAlignment.Left

            Border.Name = "Border"
            Border.Parent = Notification
            Border.BackgroundColor3 = WinTheme.Dark_Borders
            Border.BorderSizePixel = 0
            Border.Position = U2(0, 0, 0, 20)
            Border.Size = U2(1, 0, 0, 1)
            Border.ZIndex = 10002

            Body.Name = "Body"
            Body.Parent = Notification
            Body.BackgroundColor3 = RGB(255, 255, 255)
            Body.BackgroundTransparency = 1.000
            Body.Position = U2(0, 5, 0, 25)
            Body.Size = U2(1, -10, 1, -30)
            Body.ZIndex = 10002
            Body.Font = GTHM
            Body.Text = notification_info.Body
            Body.TextWrapped = true
            Body.TextColor3 = RGB(255, 255, 255)
            ...
            Progress.BackgroundColor3 = WinTheme.Accent
            Progress.BorderSizePixel = 0
            Progress.Position = U2(0, 0, 1, -1)
            Progress.Size = U2(0, 0, 0, 1)
