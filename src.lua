...
Library.NewWindow = function(window_info)
    ...
    window_info.WindowPositionCallback = window_info.WindowPositionCallback or function(x,y) print("Hi") end 
    ...
    for i, v in next, window_info.ThemeOverrides do
        local o = tostring(i)
    ...
    function root.NewPage(page_info)
        ...
        function page_funcs.NewSection(section_info)
            ...
            function section_funcs.NewDropdown(info)
                ...
                for i,v in next, info.Options do
                    addOption(v)
                end
